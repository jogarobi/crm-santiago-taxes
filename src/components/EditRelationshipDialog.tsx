...
import { useUpdateAccountRelationship } from '@/hooks/use-account-relationships';
...
export function EditRelationshipDialog({
  ...
  const updateRelationship = useUpdateAccountRelationship();
  ...
  useEffect(() => {
    if (open && relationship) {
      // Initialize form fields when dialog opens with relationship data
      // eslint-disable-next-line react-hooks/set-state-in-effect
      setRelationshipType(relationship.relationship);
      if (relationship.relatedAccount) {
        setSelectedAccount({
          id: relationship.relatedAccount.id,
          firstName: relationship.relatedAccount.firstName,
          lastName: relationship.relatedAccount.lastName,
          dateOfBirth: relationship.relatedAccount.dateOfBirth,
          ssnLastFour: '',
          address: '',
          city: '',
          state: '',
  ...
  return (
    <Dialog open={open} onOpenChange={handleDialogOpenChange}>
      <DialogContent className='max-w-lg'>
        <DialogHeader>
          <DialogTitle className='text-xl'>Edit Relationship</DialogTitle>
        </DialogHeader>
